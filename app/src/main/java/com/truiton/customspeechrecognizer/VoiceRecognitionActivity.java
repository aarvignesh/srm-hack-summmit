...
//                Intent intent = new Intent(getBaseContext(), DisplayResultsForYT.class);
//                intent.putExtra("results_arr", resultsarr);
//                startActivity(intent);

//                Intent intent = new Intent(getBaseContext(), DisplayResultsForVideoO.class);
//                startActivity(intent);

                Intent intent = new Intent(getBaseContext(), DisplayResultsForEbook.class);
                startActivity(intent);
            }
        });
